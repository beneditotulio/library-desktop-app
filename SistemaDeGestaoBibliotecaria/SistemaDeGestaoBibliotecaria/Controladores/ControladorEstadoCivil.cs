...
namespace SistemaDeGestaoBibliotecaria.Controladores
{
    ...
    {
         public static void Salvar(Modelos.EstadoCivil Model)
        {
            ...
            try
            {
                string SQL = "Insert Into TBEstadoCivil(Descricao) Values('" + Model.Descricao+ "');";
                ...
                MMov.Operacao = "Registou Estado Civil";
                MMov.Descricao = "Insert Into TBEstadoCivil(Descricao) Values " + Model.Descricao;
