    ...
    public partial class frmLocal : Form
    {
        ...
        private void CarregaDados()
        {
            ...
            try
            {
                ...
                //con.Open();
                string SQL = "Select * From TBLocal Order By(IDLocal) Desc";
                ...
                while (Dreader.Read())
                {
                    dataGridView1.Rows.Add(Dreader["IDLocal"].ToString(), Dreader["Descricao"].ToString());
        ...
        private void CarregaLocal()
        {
            ...
            try
            {
                ...
                if (Dreader.Read())
                {
                    txtCodigo.Text = Dreader["IDLocal"].ToString();
        ...
        private void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            {
                Modelos.Local MLocal = new Modelos.Local();

                MLocal.Descricao = txtDescricao.Text;
               

                Controladores.ControladorLocal.Salvar(MLocal);
