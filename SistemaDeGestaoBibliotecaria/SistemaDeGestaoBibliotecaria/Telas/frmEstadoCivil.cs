    ...
    public partial class frmEstadoCivil : Form
    {
        ...
        private void CarregaDados()
        {
            ...
            try
            {
                ...
                //con.Open();
                string SQL = "Select * From TBEstadoCivil Order By(ID) Desc";
        ...
        private void btnSalva_Click(object sender, EventArgs e)
        {
            ...
            {
                Modelos.EstadoCivil Model = new Modelos.EstadoCivil();

                Model.Descricao = txtDescricao.Text;
               

                Controladores.ControladorEstadoCivil.Salvar(Model);
